...
class experiment: 
    ...
    def build(self): 
        ...
        with net: 
            ...
            nengo.Connection(self.error, self.der_error, transform=20, synapse=0.05, label='error_to_der_error')
            nengo.Connection(self.error, self.der_error, transform=-20, synapse=0.1, label='error_to_PD_Control')
            # transform=-10, synapse=0.001

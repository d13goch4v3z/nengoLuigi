...
def setupNetwork():
    ...
    n2Core.cxCfg[0].configure(bias=100, biasExp=6, vthProfile=0, cxProfile=0)
...
if __name__ == '__main__':
    ...
    if haveDisplay:
        ...
        filpath = os.path.dirname(os.path.realpath(__file__)) + "/tutorial_01_fig1001.png"
        print("No display available, saving to file " + filpath + ".")
        fig.savefig(filpath)
